      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gray-900">
          <div className="container px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12">
              <div className="bg-black p-8 rounded-lg shadow-sm border border-gray-800 mb-12">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-black p-6 rounded-lg shadow-sm border border-gray-800">
                  <h3 className="text-xl font-semibold mb-3 text-podleaf-300">Excellence</h3>
                  <p className="text-gray-300">
                ...
                <div className="bg-black p-6 rounded-lg shadow-sm border border-gray-800">
                  <h3 className="text-xl font-semibold mb-3 text-podleaf-300">Innovation</h3>
                  <p className="text-gray-300">
                ...
                <div className="bg-black p-6 rounded-lg shadow-sm border border-gray-800">
                  <h3 className="text-xl font-semibold mb-3 text-podleaf-300">Integrity</h3>
                  <p className="text-gray-300">
                ...
                <div className="bg-black p-6 rounded-lg shadow-sm border border-gray-800">
                  <h3 className="text-xl font-semibold mb-3 text-podleaf-300">Collaboration</h3>
                  <p className="text-gray-300">
                ...
                <div className="bg-black p-6 rounded-lg shadow-sm border border-gray-800">
                  <h3 className="text-xl font-semibold mb-3 text-podleaf-300">Creativity</h3>
                  <p className="text-gray-300">
                ...
                <div className="bg-black p-6 rounded-lg shadow-sm border border-gray-800">
                  <h3 className="text-xl font-semibold mb-3 text-podleaf-300">Results-Focused</h3>
                  <p className="text-gray-300">
        ...
        <section className="py-16 bg-black text-white">
          <div className="container px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
              <div className="bg-gray-900 p-6 rounded-lg shadow-sm border border-gray-800 text-center">
                <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-4">
                  <div className="bg-gray-700 w-full h-full flex items-center justify-center">
                    <span className="text-gray-300 text-sm">Photo Placeholder</span>
                  </div>
                </div>
                <h3 className="text-xl font-semibold mb-1">Raj Patel</h3>
                <p className="text-podleaf-300 mb-3">Founder & CEO</p>
              ...
              <div className="bg-gray-900 p-6 rounded-lg shadow-sm border border-gray-800 text-center">
                ...
                <p className="text-podleaf-300 mb-3">Audio Director</p>
                <p className="text-gray-300 text-sm">
              ...
              <div className="bg-gray-900 p-6 rounded-lg shadow-sm border border-gray-800 text-center">
                ...
                <p className="text-podleaf-300 mb-3">Video Production Lead</p>
                <p className="text-gray-300 text-sm">
              ...
              <div className="bg-gray-900 p-6 rounded-lg shadow-sm border border-gray-800 text-center">
                ...
                <p className="text-podleaf-300 mb-3">Marketing Strategist</p>
                <p className="text-gray-300 text-sm">
        ...
        <section className="py-16 bg-gray-900">
          <div className="container px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
              <div className="bg-black p-6 rounded-lg shadow-sm border border-gray-800">
                <div className="h-12 w-12 rounded-lg bg-podleaf-900 flex items-center justify-center text-podleaf-300 mb-4">
            ...
            <div className="max-w-4xl mx-auto mt-12">
              <div className="aspect-video bg-gray-800 rounded-lg overflow-hidden mb-6">
                <div className="h-full w-full flex items-center justify-center">
                  <p className="text-gray-300">Map placeholder - Client will provide embed code</p>
                </div>
              </div>
